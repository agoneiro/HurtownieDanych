...
-- Tabela ³¹cz¹ca wiele-do-wiele (dziecko tabel Wizyta i Promocja)
IF OBJECT_ID('dbo.Aktywacja_Promocji', 'U') IS NOT NULL
    DROP TABLE dbo.Aktywacja_Promocji;

-- Tabela Sesja_Gry (dziecko wielu wymiarów i tabeli Wizyta)
IF OBJECT_ID('dbo.Sesja_Gry', 'U') IS NOT NULL
    DROP TABLE dbo.Sesja_Gry;

-- Tabela Wizyta (dziecko wielu wymiarów)
IF OBJECT_ID('dbo.Wizyta', 'U') IS NOT NULL
    DROP TABLE dbo.Wizyta;

-- Tabele Wymiarów (rodzice)
IF OBJECT_ID('dbo.Gracz', 'U') IS NOT NULL
    DROP TABLE dbo.Gracz;

IF OBJECT_ID('dbo.Gra', 'U') IS NOT NULL
    DROP TABLE dbo.Gra;

IF OBJECT_ID('dbo.Promocja', 'U') IS NOT NULL
    DROP TABLE dbo.Promocja;

IF OBJECT_ID('dbo.Kasyno', 'U') IS NOT NULL
    DROP TABLE dbo.Kasyno;

IF OBJECT_ID('dbo.Pracownik', 'U') IS NOT NULL
    DROP TABLE dbo.Pracownik;

-- Tabele Czasowe (nie maj¹ FK do innych tabel)
IF OBJECT_ID('dbo.Data', 'U') IS NOT NULL
    DROP TABLE dbo.Data;

IF OBJECT_ID('dbo.Czas', 'U') IS NOT NULL
    DROP TABLE dbo.Czas;
