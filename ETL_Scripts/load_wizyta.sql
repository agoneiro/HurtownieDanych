...
SELECT
    ...
    DATEDIFF(MINUTE, s.Data_wejscia, s.Data_wyjscia) AS Dlugosc_Wizyty,
...
LEFT JOIN Casino_DataWarehouse.dbo.Gracz g ON s.FK_Gracz = g.BK_gracza AND g.IsCurrent = 1 --TODO poprawic BK w Ÿródle w graczu (i zmienic na s.BK_Gracza)
