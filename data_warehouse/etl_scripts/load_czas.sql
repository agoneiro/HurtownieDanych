...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            SET @PoraDnia = CASE 
                WHEN @Hour BETWEEN 0 AND 5 THEN 'Po północy'
                WHEN @Hour BETWEEN 6 AND 11 THEN 'Ranek'
                WHEN @Hour BETWEEN 12 AND 17 THEN 'Po południu'
                ELSE 'Wieczór'
            END;
